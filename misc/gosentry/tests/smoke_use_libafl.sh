...
bash "${ROOT_DIR}/misc/gosentry/tests/smoke_use_libafl_composite.sh"
bash "${ROOT_DIR}/misc/gosentry/tests/smoke_use_libafl_reverse.sh"
bash "${ROOT_DIR}/misc/gosentry/tests/smoke_use_libafl_config.sh"
bash "${ROOT_DIR}/misc/gosentry/tests/smoke_use_libafl_focus_on_new_code.sh"
bash "${ROOT_DIR}/misc/gosentry/tests/smoke_use_libafl_addseed_testdata.sh"
bash "${ROOT_DIR}/misc/gosentry/tests/smoke_use_libafl_catch_races.sh"
bash "${ROOT_DIR}/misc/gosentry/tests/smoke_use_libafl_catch_leaks.sh"
bash "${ROOT_DIR}/misc/gosentry/tests/smoke_use_libafl_grammar_json.sh"
bash "${ROOT_DIR}/misc/gosentry/tests/smoke_use_libafl_generate_coverage.sh"
